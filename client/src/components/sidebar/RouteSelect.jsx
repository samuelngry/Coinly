...
import { FiHome, FiTrendingUp, FiStar, FiAward } from 'react-icons/fi'
import { NavLink } from 'react-router-dom'

const routes = [
    { to: '/home', label: 'Home', icon: (className) => <FiHome className={className}/>, color: 'text-blue-500' },
    { to: '/insights', label: 'Insights', icon: (className) => <FiTrendingUp className={className} />, color: 'text-emerald-500' },
