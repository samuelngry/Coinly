...
const PetBadge = ({ badge }) => {
  ...
  const rotatedBadges = [...badge.slice(currentMonthIndex), ...badge.slice(0, currentMonthIndex)];

  const visibleBadges = showAll ? rotatedBadges : rotatedBadges.slice(0, 3);

  const toggleShowAll = () => setShowAll(prev => !prev);

  return (
    <div className='mt-6 w-full max-w-2xl mx-auto'>
      <h2 className='mb-2'>Monthly Badges</h2>
